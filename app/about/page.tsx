      ...
      <div className="flex items-center gap-8">
       <Image
        ...
        <div>
          ...
          <p className="text-[20px] text-[#E3086F]"> Indonesian illustartor </p>
         ...
         className="bg-[#E9DE0D] text-[50px] text-[#E3086F] underline rounded-lg hover:text-[#F7F3EA]"> 
         RESUME 
        </Link>
        </div>
      </div>
...
inspired by them.
  ...
  <p className=" text-[20px] text-[#251B23]">
...
and working together with others around.
 ...
 <h1 className=" text-[30px] text-[#251B23] mt-10" >INTERESTS</h1>
    ...
    <p className="text-[20px] text-[#251B23]"> - mythology (specifically mahabarata) </p>
    
  <h1 className=" text-[30px] text-[#251B23] mt-10" >LANGUAGE</h1>
...
<div className="text-center">
    <Link
        href="mailto:e.agatha.susanto@gmail.com" 
         target="_blank" 
         rel="noopener noreferrer"
         className="bg-[#E3086F] text-[50px] text-[#E9DE0D] underline rounded-lg hover:text-[#F7F3EA]"
         > SEND ME AN EMAIL!
        </Link>
</div>
 <Image
